    ...
    <main className="flex max-lg:flex-col justify-between items-center h-screen max-lg:h-full text-white">
      <section className="relative bg-linear-to-br from-gd-orange to-gd-blue flex-2 max-lg:flex-none flex items-center justify-center h-screen max-lg:h-130 w-full max-lg:overflow-x-hidden">
        ...
        <img
          src={charizardImage}
          alt="charizard"
          className="absolute top-0 left-0 w-100 max-lg:w-50"
        />
        <img
          src={ivysaurImage}
          alt="ivysaur"
          className="absolute bottom-0 -right-25 max-lg:-right-10 w-80 max-lg:w-50 z-50"
        />
      ...
      <section className="flex-3 max-lg:flex-none flex flex-col gap-12 items-center justify-center bg-bg-blue p-12 h-full w-full z-0">
